        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="order-2 flex flex-col gap-8 lg:order-1">
            {FEATURES.map((feature) => (
              <div
                key={feature.id}
                className="flex gap-6 rounded-[32px] border border-slate-100 bg-white p-6 transition-all duration-300 hover:shadow-xl"
              >
                <div
          ...
          <div className="order-1 flex items-center justify-center lg:order-2">
            <div className="relative w-[340px] rounded-[50px] bg-white shadow-[0_30px_60px_rgba(0,0,0,0.3)]">
